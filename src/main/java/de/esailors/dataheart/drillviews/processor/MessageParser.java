...
//			hBaseEventWriter.close();
//		}
//
//		// post actions
//
//		outputSampleEvents();
//		generateDrillViewFiles();
//
//		analyze();
//
//		statistics();
...
//		if (!config.PROCESSOR_ANALYZE_MESSAGES) {
//			System.out.println("Analyze phase is disabled");
//			return;
//		}
//
...
//	private void outputSampleEvents() {
//		if (!config.PROCESSOR_SAMPLE_EVENTS_ENABLED) {
//			System.out.println("Event sampling disabled");
//			return;
//		}
//
//		System.out.println("Writing " + eventSamples.keySet().size() + " event samples to: " + config.PROCESSOR_SAMPLE_EVENTS_FOLDER);
//		for (String topic : eventSamples.keySet()) {
//			FileWriterUtil.writeFile(config.PROCESSOR_SAMPLE_EVENTS_FOLDER, topic + ".json",
//					DrillViewGenerator.prettyPrintJsonString(eventSamples.get(topic)));
//		}
//	}

//	private void generateDrillViewFiles() {
//		if (!config.PROCESSOR_DRILL_VIEWS_ENABLED) {
//			System.out.println("Generating Drill views is disabled");
//			return;
//		}
//
//		System.out.println("Writing " + eventSamples.keySet().size() + " drill views to: " + config.PROCESSOR_DRILL_VIEWS_FOLDER);
//
//		for (String topic : eventSamples.keySet()) {
//			String createStatement = DrillViewGenerator.generateDrillViewForJson(eventSamples.get(topic), topic);
//			FileWriterUtil.writeFile(config.PROCESSOR_DRILL_VIEWS_FOLDER, topic + ".sql", createStatement);
//		}
//
//	}
}
